...
public class JavaScriptBridge {
    ...
    public boolean startNativeModule(String moduleName, String arguments) {
        ...
        application.growl(started?title+" is starting, please wait":"Failed to launch "+title+" (check soldo.log for details)");
        return started;
    }
