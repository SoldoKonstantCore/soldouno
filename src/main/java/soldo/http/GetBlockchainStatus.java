...
public final class GetBlockchainStatus extends APIServlet.APIRequestHandler {
    ...
    protected JSONObject processRequest(HttpServletRequest req) {
        ...
        response.put("application", Soldo.APPLICATION);
        response.put("version", Soldo.VERSION);
        response.put("time", Soldo.getEpochTime());
        ...
        response.put("currentMinRollbackHeight", Soldo.getBlockchainProcessor().getMinRollbackHeight());
