...
public final class DbShellServlet extends HttpServlet {
    ...
    private static final String errorNoPasswordIsConfigured =
            "This page is password-protected, but no password is configured in soldo.properties. " +
                    "Please set soldo.adminPassword or disable the password protection with soldo.disableAdminPassword";
