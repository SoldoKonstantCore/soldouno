...
import static soldo.http.JSONData.putAccount;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if (transactionIdString != null) {
                ...
                transaction = Soldo.getBlockchain().getTransactionByFullHash(transactionFullHash);
                if (transaction == null) {
...
//        }
        ...
        if(retrun.equals("")){
            ...
            httrx = httrx + new DecimalFormat("#0.000000").format(Double.valueOf(transaction.getAmountNQT())/1000000)+" SOL"+"</td></tr><tr><td style=\"font-weight:bold\">Fee:</td><td style=\"width:80%;text-transform:none;word-break:break-all\">";
            httrx = httrx + new DecimalFormat("#0.000000").format(Double.valueOf(transaction.getFeeNQT())/1000000)+" SOL"+"</td></tr><tr><td style=\"font-weight:bold\">Recipient:</td><td style=\"width:80%;text-transform:none;word-break:break-all\">";
            ...
            long confirms =  (Soldo.getBlockchain().getHeight()-transaction.getHeight())<0?0:(Soldo.getBlockchain().getHeight()-transaction.getHeight());
...
//        }
      ...
      //  String body = ""+soldo.Constants.MAX_BALANCE_SOL;
