 ...
 * Clients first submit their transaction using {@link soldo.http.CreateTransaction} without providing the secret phrase.<br>
 * In response the client receives the unsigned transaction JSON and transaction bytes.
 * <p>
 * The client then signs and submits the signed transaction using {@link soldo.http.BroadcastTransaction}
 * <p>
 * The default wallet implements this procedure in nrs.server.js which you can use as reference.
 * <p>
 * {@link soldo.http.BroadcastTransaction} accepts the following parameters:<br>
 ...
 * <p>
 * Prunable appendages are classes implementing the {@link soldo.Appendix.Prunable} interface.
 */
