...
import soldo.http.EventListener.PendingEvent;
 ...
 * soldo.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than soldo.apiEventTimeout.</li>
 * </ul>
 *
