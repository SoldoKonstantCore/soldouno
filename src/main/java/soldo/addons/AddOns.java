...
public final class AddOns {
    ...
    static {
        ...
        Soldo.getStringListProperty("soldo.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !Soldo.getBooleanProperty("soldo.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", Soldo.isDesktopApplicationEnabled() ? "soldodesktop.policy" : "soldo.policy");
