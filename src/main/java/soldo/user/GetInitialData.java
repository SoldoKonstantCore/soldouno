...
public final class GetInitialData extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        try (DbIterator<? extends Transaction> transactions = Soldo.getTransactionProcessor().getAllUnconfirmedTransactions()) {
        ...
        try (DbIterator<? extends Block> lastBlocks = Soldo.getBlockchain().getBlocks(0, 59)) {
