...
public class SSLCert {
    ...
    private String commonName = "SoldoCore";
    private String organizationalUnit = "Users";
    private String organization = "Soldo Community";
    private String city = "Soldo";
    private String state = "Soldo";
    private String country = "EN";
    private long validity = 4384; // 3 years
    private String alias = "soldo";
