...
public abstract class SOLException extends Exception {
    ...
    public static final class SoldoIOException extends IOException {

        public SoldoIOException(String message) {
            super(message);
        }

        public SoldoIOException(String message, Throwable cause) {
            super(message, cause);
        }
