/******************************************************************************
 * Copyright © 2020-2021    The SOLDO Developers.                             *
 *                                                                            *
 ...
 * SOLDO software, including this file, may be copied, modified, propagated,    *
...
var NRS = (function(NRS, $, undefined) {
  ...
  NRS.nextColor = function(sublevel) {
    ...
    if (senderRS != null && String(senderRS) == "SOLDO-5H5H-PRS4-UYTA-8GY83") {
				...
				if (responsePoll.transaction) {
					NRS.sendRequest("getPhasingPollVote", {
						...
						if (vm == 1) {
							$popoverTypeTR.find("td:first").html($.t('accounts', 'Accounts') + ":");
							$popoverTypeTR.find("td:last").html(String(attachment.phasingWhitelist ? attachment.phasingWhitelist.length : ""));
							votesFormatted = NRS.convertToSOLDO(responsePoll.result) + " / " + NRS.convertToSOLDO(attachment.phasingQuorum) + " SOLDO";
							$popoverVotesTR.find("td:last").html(votesFormatted);
						}
						if (mbModel == 1) {
							if (minBalance > 0) {
								minBalanceFormatted = NRS.convertToSOLDO(minBalance) + " SOLDO";
    ...
    NRS.getDiscoveryState(function(state){
      if (state == NRS.DISCOVERY_PUBLIC) {
        var options2 = {
          ...
          "titleHTML": '<svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.93758 0.083252C7.65242 0.083252 6.59383 1.14185 6.59383 2.427V5.552C6.59383 6.83716 7.65242 7.89575 8.93758 7.89575H9.71883V9.97909H6.073C4.78784 9.97909 3.72925 11.0377 3.72925 12.3228V13.1041H2.948C1.66284 13.1041 0.604248 14.1627 0.604248 15.4478V18.5728C0.604248 19.858 1.66284 20.9166 2.948 20.9166H6.073C7.35815 20.9166 8.41675 19.858 8.41675 18.5728V15.4478C8.41675 14.1627 7.35815 13.1041 6.073 13.1041H5.29175V12.3228C5.29175 11.882 5.63211 11.5416 6.073 11.5416H14.9272C15.368 11.5416 15.7084 11.882 15.7084 12.3228V13.1041H14.9272C13.642 13.1041 12.5834 14.1627 12.5834 15.4478V18.5728C12.5834 19.858 13.642 20.9166 14.9272 20.9166H18.0522C19.3373 20.9166 20.3959 19.858 20.3959 18.5728V15.4478C20.3959 14.1627 19.3373 13.1041 18.0522 13.1041H17.2709V12.3228C17.2709 11.0377 16.2123 9.97909 14.9272 9.97909H11.2813V7.89575H12.0626C13.3477 7.89575 14.4063 6.83716 14.4063 5.552V2.427C14.4063 1.14185 13.3477 0.083252 12.0626 0.083252H8.93758ZM8.93758 1.64575H12.0626C12.5035 1.64575 12.8438 1.98612 12.8438 2.427V5.552C12.8438 5.99289 12.5035 6.33325 12.0626 6.33325H8.93758C8.4967 6.33325 8.15633 5.99289 8.15633 5.552V2.427C8.15633 1.98612 8.4967 1.64575 8.93758 1.64575ZM2.948 14.6666H6.073C6.51388 14.6666 6.85425 15.007 6.85425 15.4478V18.5728C6.85425 19.0137 6.51388 19.3541 6.073 19.3541H2.948C2.50711 19.3541 2.16675 19.0137 2.16675 18.5728V15.4478C2.16675 15.007 2.50711 14.6666 2.948 14.6666ZM14.9272 14.6666H18.0522C18.493 14.6666 18.8334 15.007 18.8334 15.4478V18.5728C18.8334 19.0137 18.493 19.3541 18.0522 19.3541H14.9272C14.4863 19.3541 14.1459 19.0137 14.1459 18.5728V15.4478C14.1459 15.007 14.4863 14.6666 14.9272 14.6666Z" fill="black"/></svg>  <span data-i18n="my_disciples">Network</span>',
          "page": 'hierarchy',
          "desiredPosition": 17,
        };
