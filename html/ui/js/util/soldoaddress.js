/*
    SOLDO address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: modified SOLDO GROUP.
*/

function SoldoAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('SOLDO-') == 0) adr = adr.substr(6);
