...
var NRS = (function (NRS) {
    ...
    NRS.getDiscoveryState = function (callback) {
      NRS.sendRequest("getParent", {"account":"SOLDO-5H5H-PRS4-UYTA-8GY83"}, function(response){
        if (response.errorDescription) {
          ...
          if (response.parentRS.lastIndexOf("SOLDO-", 0) === 0 || NRS.compareStrings(response.errorDescription, 'Incorrect "account"')) {
