...
var NRS = (function(NRS, $) {
	...
	var index = 0;
	var bundles = [
		{alias: "nrsVersion", status: "release", prefix: "soldo-client-", ext: "zip"},
		{alias: "nrsBetaVersion", status: "beta", prefix: "soldo-client-", ext: "zip"},
		{alias: "nrsVersionWin", status: "release", prefix: "soldo-client-", ext: "exe"},
		{alias: "nrsBetaVersionWin", status: "beta", prefix: "soldo-client-", ext: "exe"},
		{alias: "nrsVersionMac", status: "release", prefix: "soldo-installer-", ext: "dmg"},
		{alias: "nrsBetaVersionMac", status: "beta", prefix: "soldo-installer-", ext: "dmg"},
		{alias: "nrsVersionLinux", status: "release", prefix: "soldo-client-", ext: "sh"},
		{alias: "nrsBetaVersionLinux", status: "beta", prefix: "soldo-client-", ext: "sh"}
	];
